                ...
                <div class="row">
                    <div class="col-6 d-block mx-auto">
                        <div class="bg-info rounded-4 d-inline-block p-2 mb-3">
                            ...
                            <div class="fw-semibold fs-5 py-1 px-2"><i class="fa-solid fa-wallet"></i> Saldo {{ $student->user->name }} : <span
                                    class="fw-light">{{ number_format(intval($student->jumlah), 0, ',', '.') }}</span></div>
                        </div>
                    </div>
                    <div class="col-6 d-block mx-auto">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="POST" action="{{route('admin.students.store', $student->id)}}">
                                    @csrf
